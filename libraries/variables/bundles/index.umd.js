(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('angular2-websocket/angular2-websocket'), require('@angular/router'), require('@wm/core'), require('@angular/core'), require('@angular/common'), require('@angular/common/http'), require('ngx-toastr'), require('@wm/http'), require('@wm/security'), require('@wm/oAuth')) :
    typeof define === 'function' && define.amd ? define('@wm/variables', ['exports', 'angular2-websocket/angular2-websocket', '@angular/router', '@wm/core', '@angular/core', '@angular/common', '@angular/common/http', 'ngx-toastr', '@wm/http', '@wm/security', '@wm/oAuth'], factory) :
    (factory((global.wm = global.wm || {}, global.wm.variables = {}),global.angularWebSocket,global.ng.router,global.wm.core,global.ng.core,global.ng.common,global.ng.common.http,global.ngxToastr,global.wm.http,global.wm.security,global.wm.oAuth));
}(this, (function (exports,angular2Websocket,router,core,core$1,common,http,ngxToastr,http$1,security,oAuth) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var triggerOnTimeout = function (success) {
        setTimeout(function () { core.triggerFn(success); }, 500);
    };
    ...
    var simulateFileDownload = function (requestParams, fileName, exportFormat, success, error) {
        ...
        if (CONSTANTS.hasCordova) {
            ...
            exports.appManager.notify('device-file-download', { url: requestParams.url, name: fileName, extension: fileExtension, successCb: success, errorCb: error });
        }
    ...
    var LiveVariableUtils = /** @class */ (function () {
        ...
        LiveVariableUtils.getSearchField = function (fieldValue, ignoreCase, skipEncode) {
            ...
            // If value is an empty array, do not generate the query
            // If values is NaN and number type, do not generate query for this field
            if ((isValArray && _.isEmpty(value)) || (isValArray && _.some(value, function (val) { return (_.isNull(val) || _.isNaN(val) || val === ''); })) || (!isValArray && isNaN(value) && core.isNumberType(fieldValue.attributeType))) {
                return;
            }
            if (isValArray) {
                // If array is value and mode is between, pass between. Else pass as in query
