(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('@wm/core')) :
    typeof define === 'function' && define.amd ? define('@wm/oAuth', ['exports', '@angular/core', 'rxjs', '@wm/core'], factory) :
    (factory((global.wm = global.wm || {}, global.wm.oAuth = {}),global.ng.core,global.rxjs,global.wm.core));
    ...
    var performAuthorization = function (url, providerId, onSuccess, onError, http, addProviderConfigCallBack, removeProviderConfigCallBack) {
        ...
        if (url) {
            if (core$1.isIE()) { // handling for IE
