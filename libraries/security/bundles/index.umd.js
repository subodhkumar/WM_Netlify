(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/router'), require('@wm/core')) :
    typeof define === 'function' && define.amd ? define('@wm/security', ['exports', '@angular/core', '@angular/common', '@angular/router', '@wm/core'], factory) :
    (factory((global.wm = global.wm || {}, global.wm.security = {}),global.ng.core,global.ng.common,global.ng.router,global.wm.core));
    ...
    var SecurityService = /** @class */ (function () {
        ...
        SecurityService.prototype.getConfig = function (successCallback, failureCallback) {
            function invokeQueuedCallbacks(id, method, data) {
                _.forEach(this.requestQueue[id], function (fn) { return core$1.triggerFn(fn[method], data); });
