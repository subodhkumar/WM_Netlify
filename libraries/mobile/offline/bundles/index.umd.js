(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@ionic-native/app-version'), require('@ionic-native/file'), require('@ionic-native/sqlite'), require('@wm/security'), require('rxjs'), require('@angular/core'), require('@wm/core'), require('@wm/mobile/core'), require('@wm/variables')) :
    typeof define === 'function' && define.amd ? define('@wm/mobile/offline', ['exports', '@angular/common', '@ionic-native/app-version', '@ionic-native/file', '@ionic-native/sqlite', '@wm/security', 'rxjs', '@angular/core', '@wm/core', '@wm/mobile/core', '@wm/variables'], factory) :
    (factory((global.wm = global.wm || {}, global.wm.mobile = global.wm.mobile || {}, global.wm.mobile.offline = {}),global.ng.common,global.ionicNative.plugins,global.ionicNative.plugins,global.ionicNative.plugins,global.wm.security,global.rxjs,global.ng.core,global.wm.core,global.wm.mobile.core,global.wm.variables));
}(this, (function (exports,common,i1,i3,i6,i5,rxjs,i0,i1$1,i2,variables) { 'use strict';
        ...
        LocalDBStore.prototype.add = function (entity) {
            if (this.primaryKeyName) {
                ...
                if (this.primaryKeyField.sqlType === 'number'
                    && (!i1$1.isDefined(idValue) || (_.isString(idValue) && _.isEmpty(_.trim(idValue))))) {
    ...
    var LocalDBManagementService = /** @class */ (function () {
        ...
        LocalDBManagementService.prototype.executeNamedQuery = function (dbName, queryName, params) {
            ...
            paramPromises = _.chain(queryData.params)
                ...
                return i1$1.toPromise(paramValue).then(function (v) { return params[p.name] = v; });
            }).value();
                        ...
                        if (!_.isUndefined(needTransform)) {
                            result.rows = _.map(result.rows, function (row) {
                                ...
                                _.forEach(queryData.response.properties, function (p) {
                                    ...
                                    var propType = i1$1.extractType(p.fieldType.typeRef);
                                    var formatValue = i1$1.DEFAULT_FORMATS[_.toUpper(propType)];
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this.file.createDir(cordova.file.cacheDirectory, folderToExport, false)
                    ...
                    return _this.file.copyDir(_this.dbInstallParentDirectory, _this.dbInstallDirectoryName, folderToExportFullPath, 'databases')
                        ...
                        return metaInfo;
                    }).then(function () { return i1$1.executePromiseChain(_this.getCallbacksFor('preExport'), [folderToExportFullPath, metaInfo]); })
                        .then(function () {
        ...
        LocalDBManagementService.prototype.importDB = function (zipPath, revertIfFails) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this.file.createDir(cordova.file.cacheDirectory, importFolder, false)
                    ...
                    }).then(function () { return i1$1.executePromiseChain(_this.getCallbacksFor('postImport'), [importFolderFullPath, zipMeta]); })
                        .then(function () {
                        if (backupZip) {
                ...
                return this.setUpDatabases()
                    ...
                    if (newDatabasesCreated) {
                        return _this.normalizeData()
                            ...
                            return i1$1.executePromiseChain(_.map(_this.callbacks, 'onDbCreate'), [{
        ...
        LocalDBManagementService.prototype.loadDBSchemas = function () {
            ...
            return this.getMetaInfo(/.+_dataModel\.json$/)
                ...
                schemas = i1$1.isArray(schemas) ? schemas : [schemas];
    ...
    var ChangeLogService = /** @class */ (function () {
        ...
        ChangeLogService.prototype.add = function (service, operation, params) {
            ...
            return i1$1.executePromiseChain(this.getWorkers('transformParamsToMap'), [change])
                .then(function () { return i1$1.executePromiseChain(_this.getWorkers('onAddCall'), [change]); })
                .then(function () {
                change.params = JSON.stringify(change.params);
                return _this.getStore().then(function (store) { return store.add(change); }).then(i1$1.noop);
            });
        };
        ...
        ChangeLogService.prototype.flush = function (progressObserver) {
            ...
            if (!this.deferredFlush) {
                ...
                this.createContext().then(function (context) {
                    ...
                    return i1$1.executePromiseChain(_this.getWorkers('preFlush'), [_this.flushContext]);
                })
                    .then(function () {
                    ...
                    Promise.resolve().then(function () {
                        ...
                        return i1$1.executePromiseChain(_this.getWorkers('postFlush'), [_this.currentPushInfo, _this.flushContext]);
                    });
                });
            }
        ...
        ChangeLogService.prototype.getChanges = function () {
            return this.getStore().then(function (s) {
                return s.filter(undefined, 'id', {
                    offset: 0,
                    limit: 500
                });
        ...
        ChangeLogService.prototype.getLastPushInfo = function () {
            return this.localKeyValueService.get(LAST_PUSH_INFO_KEY)
                .then(function (info) {
                if (i1$1.isString(info.startTime)) {
                    info.startTime = new Date(info.startTime);
                }
                if (i1$1.isString(info.endTime)) {
        ...
        */
        ...
        ChangeLogService.prototype.flushChange = function (change) {
            ...
            return i1$1.executePromiseChain(this.getWorkers('preCall'), [change])
                ...
                .then(function () { return i1$1.executePromiseChain(_this.getWorkers('transformParamsFromMap'), [change]); })
                .then(function () { return _this.pushService.push(change); })
                .then(function () {
                return i1$1.executePromiseChain(_.reverse(self.getWorkers('postCallSuccess')), [change, arguments])
                    .then(function () { return change; });
            }).catch(function () {
                if (self.networkService.isConnected()) {
                    return i1$1.executePromiseChain(_.reverse(self.getWorkers('postCallError')), [change, arguments])
                        .catch(i1$1.noop).then(function () { return Promise.reject(change); });
                }
        ...
        ChangeLogService.prototype.getNextChange = function () {
            ...
            return this.getStore().then(function (s) {
                return s.filter(filterCriteria, 'id', {
                    offset: 0,
                    limit: 1
                });
            }).then(function (changes) {
        ...
        /** @nocollapse */
        ChangeLogService.ctorParameters = function () {
            return [
                { type: LocalDBManagementService },
                { type: LocalKeyValueService },
                { type: PushService },
                { type: i2.NetworkService }
            ];
        };
        ChangeLogService.ngInjectableDef = i0.defineInjectable({ factory: function ChangeLogService_Factory() { return new ChangeLogService(i0.inject(LocalDBManagementService), i0.inject(LocalKeyValueService), i0.inject(PushService), i0.inject(i2.NetworkService)); }, token: ChangeLogService, providedIn: "root" });
    ...
    var LocalDbService = /** @class */ (function () {
        ...
        /** @nocollapse */
        LocalDbService.ctorParameters = function () {
            return [
                { type: LocalDBManagementService }
            ];
        };
        LocalDbService.ngInjectableDef = i0.defineInjectable({ factory: function LocalDbService_Factory() { return new LocalDbService(i0.inject(LocalDBManagementService)); }, token: LocalDbService, providedIn: "root" });
    ...
    var IdResolver = /** @class */ (function () {
        ...
        IdResolver.prototype.postCallSuccess = function (change, response) {
            ...
            if (change && change.service === 'DatabaseService'
                ...
                return this.localDBManagementService.getStore(dataModelName_2, entityName_2).then(function (store) {
                    ...
                    return store.delete(_this.transactionLocalId).catch(i1$1.noop).then(function () {
                        _this.transactionLocalId = null;
        ...
        /** @nocollapse */
        IdResolver.ctorParameters = function () {
            return [
                { type: LocalDBManagementService }
            ];
        };
    ...
    var LiveVariableOfflineBehaviour = /** @class */ (function () {
        function LiveVariableOfflineBehaviour(changeLogService, httpService, localDBManagementService, networkService, offlineDBService) {
            ...
            this.onlineDBService = variables.LVService;
        }
                ...
                if (onlineHandler_1) {
                    this.httpService.sendCallAsObservable = function (reqParams, params) {
                        ...
                        if (_this.networkService.isConnected() || params.onlyOnline || !operation || !params.dataModelName) {
                            return rxjs.from(_this.remoteDBcall(operation, onlineHandler_1, params));
                        }
                        // converting promise to observable as LVService returns a observable
                        return rxjs.from(_this.localDBManagementService.isOperationAllowed(params.dataModelName, params.entityName, operation.type)
                        ...
                        if (!params.skipLocalDB) {
                            _this.offlineDBService.getStore(params).then(function (store) {
                                if (operation.type === 'READ' && operation.saveResponse) {
                                    ...
                                    _this.offlineDBService[operation.name](params, i1$1.noop, i1$1.noop);
                                }
                                else {
                                    _this.offlineDBService[operation.name](params, i1$1.noop, i1$1.noop);
                                }
        ...
        NamedQueryExecutionOfflineBehaviour.prototype.add = function () {
            ...
            this.httpService.sendCallAsObservable = function (reqParams, params) {
                ...
                if (!_this.networkService.isConnected() && params.url.indexOf('/queryExecutor/') > 0) {
                    return rxjs.from(_this.executeLocally(params));
                }
                else {
    ...
    var SecurityOfflineBehaviour = /** @class */ (function () {
        ...
        SecurityOfflineBehaviour.prototype.add = function () {
            ...
            this.securityService.appLogout = function (successCallback, failureCallback) {
                ...
                _this._saveSecurityConfigLocally(_this.securityConfig).catch(i1$1.noop).then(function () {
                    if (_this.networkService.isConnected()) {
            ...
            this.securityService.isAuthenticated = function (successCallback) {
                i1$1.triggerFn(successCallback, _this.securityConfig.authenticated === true);
            };
    ...
    var OfflineModule = /** @class */ (function () {
        ...
        /** @nocollapse */
        OfflineModule.ctorParameters = function () {
            return [
                { type: i1$1.App },
                { type: ChangeLogService },
                { type: i2.DeviceService },
                { type: i2.DeviceFileService },
                { type: i2.DeviceFileUploadService },
                { type: i3.File },
                { type: i1$1.AbstractHttpService },
                { type: LocalDBManagementService },
                { type: LocalDbService },
                { type: i2.NetworkService },
                { type: i5.SecurityService }
    ...
    var PushServiceImpl = /** @class */ (function () {
        ...
        PushServiceImpl.prototype.push = function (change) {
            ...
            switch (change.service) {
                case 'DatabaseService':
                    switch (change.operation) {
                        case 'insertTableData':
                            return this.getPromiseFromObs(variables.LVService.insertTableData(change.params, null, null));
                        case 'insertMultiPartTableData':
                            return this.getPromiseFromObs(variables.LVService.insertMultiPartTableData(change.params, null, null));
                        case 'updateTableData':
                            return this.getPromiseFromObs(variables.LVService.updateTableData(change.params, null, null));
                        case 'updateMultiPartTableData':
                            return this.getPromiseFromObs(variables.LVService.updateMultiPartTableData(change.params, null, null));
                        case 'deleteTableData':
                            return this.getPromiseFromObs(variables.LVService.deleteTableData(change.params, null, null));
                    }
        ...
        /** @nocollapse */
        PushServiceImpl.ctorParameters = function () {
            return [
                { type: i2.DeviceFileUploadService }
            ];
        };
    ...
    var LocalDBDataPullService = /** @class */ (function () {
        ...
        LocalDBDataPullService.prototype.executeDatabaseCountQuery = function (params) {
            return new Promise(function (resolve, reject) {
                variables.LVService.countTableDataWithQuery(params, null, null).subscribe(function (response) { return resolve(response.body); }, reject);
            });
        };
        /**
        ...
        LocalDBDataPullService.prototype.executeDatabaseSearchQuery = function (params) {
            return new Promise(function (resolve, reject) {
                return variables.LVService.searchTableDataWithQuery(params, null, null).subscribe(function (response) { return resolve(response && response.body && response.body.content); }, reject);
            });
        };
        /**
        ...
        LocalDBDataPullService.prototype.prepareQuery = function (db, entityName) {
            ...
            return this.localDBManagementService.isBundled(db.schema.name, entityName)
                ...
                if (isBundledEntity || _.isEmpty(entitySchema.pullConfig.query)) {
                    ...
                    query = variables.LiveVariableUtils.getSearchQuery(query, ' AND ', true);
                }
                else {
        ...
        LocalDBDataPullService.prototype.pullAllDbData = function (clearDataBeforePull, progressObserver) {
            var _this = this;
            var deferred = i1$1.getAbortableDefer(), pullInfo = {
                completedTaskCount: 0,
                totalTaskCount: 0,
                inProgress: true,
                databases: [],
        ...
        LocalDBDataPullService.prototype.pullDbData = function (databaseName, clearDataBeforePull, progressObserver) {
            var _this = this;
            var deferred = i1$1.getAbortableDefer();
        ...
        /** @nocollapse */
        LocalDBDataPullService.ctorParameters = function () {
            return [
                { type: i1$1.App },
                { type: LocalDBManagementService },
                { type: LocalKeyValueService },
        ...
        LocalDBDataPullService.ngInjectableDef = i0.defineInjectable({ factory: function LocalDBDataPullService_Factory() { return new LocalDBDataPullService(i0.inject(i1$1.App), i0.inject(LocalDBManagementService), i0.inject(LocalKeyValueService), i0.inject(i2.NetworkService)); }, token: LocalDBDataPullService, providedIn: "root" });
    ...
    exports.ɵa = LocalKeyValueService;
