...
import { __awaiter, __generator, __extends, __assign, __spread, __values, __read } from 'tslib';
...
var PrefabDirective$1 = /** @class */ (function () {
    function PrefabDirective$$1(componentInstance, vcRef, elRef, prefabMngr, resolver, injector, componentRefProvider) {
        var _this = this;
        this.componentInstance = componentInstance;
        this.vcRef = vcRef;
        this.elRef = elRef;
    ...
    /** @nocollapse */
    PrefabDirective$$1.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: Self }, { type: Inject, args: [WidgetRef,] }] },
        { type: ViewContainerRef },
        { type: ElementRef },
...
var getHttpDependency = function () {
    var httpService$$1 = this.httpService;
...
var AppRef = /** @class */ (function () {
    function AppRef(inj, i18nService, httpService$$1, securityService) {
        this.inj = inj;
...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(securityService, appManager$$1) {
        this.securityService = securityService;
...
var RoleGuard = /** @class */ (function () {
    function RoleGuard(securityService, authGuard, toasterService, app, appManager$$1) {
        this.securityService = securityService;
...
var PageNotFoundGaurd = /** @class */ (function () {
    function PageNotFoundGaurd(app, appManager$$1) {
        this.app = app;
        this.appManager = appManager$$1;
    }
...
var getDynamicComponent = function (selector, template, css) {
    ...
    var DynamicComponent = /** @class */ (function () {
        ...
        DynamicComponent.decorators = [
            { type: Component, args: [__assign({}, componentDef, { selector: selector }),] },
        ];
...
var DynamicComponentRefProviderService = /** @class */ (function () {
    function DynamicComponentRefProviderService(app, appManager$$1, compiler) {
        this.app = app;
        this.appManager = appManager$$1;
        this.compiler = compiler;
        this.counter = 1;
...
var carouselModule = CarouselModule.forRoot();
var bsDropDownModule = BsDropdownModule.forRoot();
var popoverModule = PopoverModule.forRoot();
var tooltipModule = TooltipModule.forRoot();
...
var AppVariablesResolve = /** @class */ (function () {
    function AppVariablesResolve(appManager$$1, appVariablesProvider) {
        this.appManager = appManager$$1;
...
var MetadataResolve = /** @class */ (function () {
    function MetadataResolve(appManager$$1) {
        this.appManager = appManager$$1;
    }
...
var SecurityConfigResolve = /** @class */ (function () {
    function SecurityConfigResolve(appManager$$1) {
        this.appManager = appManager$$1;
